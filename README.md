...
This module was largely modified from the https://github.com/Azure/terraform-azurerm-naming module provided by microsoft. It allows full name generation and provides checks.
...
If you would like to use a pre-built naming convention set one of the following to true

```tf
microsoft_caf_naming_standard
    order ["sub_resource_type", "resource_type", "app_name", "environment", "region", "padding"]
least_to_most_naming_standard 
    order: ["region", "environment", "context", "business_unit", "app_name", "resource_type", "sub_resource_type"]
most_to_least_naming_standard
    order: ["sub_resource_type", "resource_type", "app_name", "business_unit", "context", "environment", "region"]
```
...
| <a name="output_resource_name_check_max"></a> [resource\_name\_check\_max](#output\_resource\_name\_check\_max) | n/a |
| <a name="output_resource_name_check_min"></a> [resource\_name\_check\_min](#output\_resource\_name\_check\_min) | n/a |
| <a name="output_resource_name_check_regex"></a> [resource\_name\_check\_regex](#output\_resource\_name\_check\_regex) | n/a |
| <a name="output_resource_type_details"></a> [resource\_type\_details](#output\_resource\_type\_details) | n/a |
...
| <a name="output_valid_name"></a> [valid\_name](#output\_valid\_name) | n/a |
