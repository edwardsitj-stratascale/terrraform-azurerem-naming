...
output "resource_type_details" {
    value = local.az["${var.resource_type}"]
}
...
output "valid_name" {
    value = local.valid_name
}

output "resource_name_check_regex"{
  value = local.resource_name_check_regex
}
output "resource_name_check_min" {
  value = local.resource_name_check_min
}
output "resource_name_check_max" {
  value = local.resource_name_check_max
}